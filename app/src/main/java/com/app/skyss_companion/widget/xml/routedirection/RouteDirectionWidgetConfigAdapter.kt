...
class RouteDirectionWidgetConfigAdapter(private val onItemTapped: (String, String) -> Unit) : RecyclerView.Adapter<RouteDirectionWidgetConfigAdapter.ViewHolder>() {
    ...
    open class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        var routeDirectionLineCode: TextView = view.findViewById(R.id.bookmarked_routedirection_linecode)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.routeDirectionLineCode.text = item.lineCode
        holder.stopGroupName.text = item.stopGroupName
        holder.routeDirectionName.text = item.routeDirectionName
        holder.layout.setOnClickListener { onItemTapped(item.routeDirectionIdentifier, item.stopGroupIdentifier) }
    }
