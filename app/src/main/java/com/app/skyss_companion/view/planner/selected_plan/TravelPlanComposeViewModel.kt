...
@HiltViewModel
class TravelPlanComposeViewModel @Inject constructor(
    ...
    fun fetchTravelPlanByUrl(url: String) {
        viewModelScope.launch(Dispatchers.IO) {
            Log.d(tag, "[fetchTravelPlan] attempting to fetch travel plan with url $url.")
            val travelPlan = travelPlannerRepository.getTravelPlanByUrl(url)
            travelPlan?.let { root ->
    ...
    fun fetchTravelPlanById(id: String) {
        viewModelScope.launch(Dispatchers.IO) {
            Log.d(tag, "[fetchTravelPlan] attempting to ftech travel plan with id $id.")
