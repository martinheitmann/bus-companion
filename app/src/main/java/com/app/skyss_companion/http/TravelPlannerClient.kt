...
class TravelPlannerClient @Inject constructor(
    ...
    private val classTag = "CLIENT-941861"
    ...
    suspend fun getTravelPlans(
        ...
        val httpUrl =
            HttpUrl.Builder()
                ...
                .addQueryParameter("walkSpeed", "normal")
                .build()
                .toString()
        ...
        Log.d(classTag, "[getTravelPlans] requesting travel plans by constructed url $request")
    ...
    suspend fun getTravelPlanById(
        ...
        Log.d(classTag, "[getTravelPlanById] requesting travel plan by constructed url $request.")
    ...
    @WorkerThread
    suspend fun getTravelPlanByUrl(url: String): ApiTravelPlannerResponse? {
        Log.d(classTag, "[getTravelPlanByUrl] requesting travel plan by provided url $url.")
